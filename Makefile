...
obb_graph: obbgraphwriter.o gen_mb_funcs.o
	$(CC) obb_graph.cpp gen_mb_funcs.o obbgraphwriter.o -o obb_graph $(INCLUDE_DIRS) $(LIBS)
...
obbgraphwriter.o:
	$(CC) obbgraphwriter.cpp $(INCLUDE_DIRS) $(LIBS) -c -o obbgraphwriter.o
